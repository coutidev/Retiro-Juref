...
const SuccessPage: React.FC = () => {
  ...
  useEffect(() => {
    // Adiciona um pequeno atraso para garantir que a transição CSS seja aplicada
  ...
  const itemsToBring = [
    ...
    'Roupas de cama (lençol, fronha, cobertor)',
    'Toalha de banho',
  ...
  return (
    <div className={`w-full max-w-2xl transition-opacity duration-1000 ease-in-out ${isMounted ? 'opacity-100' : 'opacity-0'}`}>
      <div className="bg-black/75 backdrop-blur-sm p-6 sm:p-8 rounded-xl shadow-2xl border border-amber-400/30 text-center">
        ...
        <p className="text-gray-400 mt-2 mb-8">Agradecemos seu interesse. Abaixo está uma lista de itens essenciais para levar ao retiro.</p>
